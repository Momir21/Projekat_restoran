...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2024 at 03:28 PM
...
(3, 'Grilovani losos sa limunom', 'glavno jelo', 3399, 'Fileti lososa pripremljeni na rostilju zacinjeni solju, biberom, maslinovim uljem isvezim sokom limu'),
...
(5, 'Cokoladni lava kolac ', 'desert', 1255, 'Kolač se priprema od tamne čokolade, maslaca, jaja, šećera i brašna, a peče se kratko na visokoj tem'),
...
CREATE TABLE `narudzbina` (
  `id` int(11) NOT NULL,
  `jelo_id` bigint(20) DEFAULT NULL,
  `pice_id` bigint(20) DEFAULT NULL,
...
--
ALTER TABLE `narudzbina`
  ADD CONSTRAINT `narudzbina_ibfk_1` FOREIGN KEY (`jelo_id`) REFERENCES `jelo` (`id`),
  ADD CONSTRAINT `narudzbina_ibfk_2` FOREIGN KEY (`pice_id`) REFERENCES `pice` (`id`);
COMMIT;
